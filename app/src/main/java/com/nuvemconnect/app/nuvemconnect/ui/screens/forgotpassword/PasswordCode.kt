...
@Composable
fun PasswordCode(modifier: Modifier = Modifier) {
    Column {
        Column(
            ...
            Text(
                text = "Enviamos um e-mail para o seu e-mail, verifique seu e-mail e digite o número abaixo",
                fontSize = 16.sp,
                color = Color.Gray,
            ...
            Text(
                text = "No lugar  text sera o number field dos codigos",
