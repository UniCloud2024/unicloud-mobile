...
import com.nuvemconnect.app.nuvemconnect.navigation.graph.auth.navigateToAuthGraphWithClearBackstack
...
fun VerificationLinkScreen(
    ...
    Column(
        ...
        TopBar(
            ...
            headingTitle = "",
            subtitleText = "",
            onBackClick = { navController.navigateToAuthGraphWithClearBackstack() },
        )
